...
async function removeDepartment() {
  ...
  const { departmentId } = await prompt({
    ...
    name: "departmentId",
    message:
      "Which department would you like to remove? This will permanently remove the employee from the database",
    choices: departmentChoices
  });
...
function quit() {
  console.log("Thank you!  The database has been updated.  Have a good day!");
  process.exit();
}
